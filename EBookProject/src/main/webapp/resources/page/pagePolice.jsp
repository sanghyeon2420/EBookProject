			...
			<div class="setTitle">
				...
				<div id="headTitle">
					<div class="name">
						<h1>무림순경</h1>
						<h4>&nbsp;작가 지챤주</h4>
						&nbsp;조회수 <i class="fas fa-check-circle"></i> 26678 &nbsp;추천수 <i
							class="far fa-heart"></i> 670
					</div>
					<div class="blank"></div>
					<div class="container">
						<div class="item">
							<i class="far fa-thumbs-up"></i><br> 랭킹<br>4위
						</div>
						<div class="item">
				...
				<div class="detail_list">
					<ol>
						<li><a href="javascript://7" onclick="#">
								<p class="text">
									<strong> 7. 고독</strong> <span>2021.03.24</span>
								</p>
								<p class="approval">
						...
						<li><a href="javascript://6" onclick="#">
								<p class="text">
									<strong> 6. 추격 </strong> <span>2021.03.24</span>
								</p>
								<p class="approval">
									<span class="coin_necessary" style="margin-right: 0.01rem;">3쿠키</span>
								</p>
						...
						<li><a href="javascript://5" onclick="#">
								<p class="text">
									<strong> 5. 협객사냥</strong> <span>2021.03.24</span>
								</p>
								<p class="approval">
									<span class="coin_necessary" style="margin-right: 0.01rem;">3쿠키</span>
								</p>
						...
						<li><a href="javascript://4" onclick="#">
								<p class="text">
									<strong> 4. 도원정점</strong> <span>2021.03.24</span>
								</p>
								<p class="approval">
									<span class="coin_necessary" style="margin-right: 0.01rem;">3쿠키</span>
								</p>
						...
						<li><a href="javascript://3" onclick="#">
								<p class="text">
									<strong> 3. 도주</strong> <span>2021.03.24</span>
								</p>
								<p class="approval">
						...
						<li><a href="javascript://2" onclick="#">
								<p class="text">
									<strong> 2. 살신성인</strong> <span>2021.03.24</span>
								</p>
								<p class="approval">
									<span class="free_coin_info" style="margin-right: 0.01rem;">무료</span>
								</p>
						...
						<li><a href="javascript://1" onclick="#">
								<p class="text">
									<strong> 1. 중원의 순찰자</strong> <span>2021.03.24</span>
								</p>
								<p class="approval">
									<span class="free_coin_info" style="margin-right: 0.01rem;">무료</span>
								</p>
