...
<body>
    ...
    <header id="headTitle">
        <div class="name">
            <h1>환골탈태하고 헌터되기</h1>
            <h4>&nbsp;작가 기뮤치뮤</h4>
            &nbsp;조회수  <i class="fas fa-check-circle"></i> 8318
            &nbsp;추천수  <i class="far fa-heart"></i> 309
            <br><br><br><br>
        </div>
        <div class="container">
            <div class="item"> <i class="far fa-thumbs-up"></i><br> 랭킹<br>6위 </div>
     ...
     <main id="mainDetail">
         <div class="detail">
             <h4>책 소개</h4>
         <p>베테랑 기뮤치뮤 작가님의 신작 무협소설!<br>
         	지긋지긋한 이 세상에서 헌터로 살아남기위한 중년의 이야기!<br>
         	환골탈태, 그리고 현경이라는 경지에 도달했다. 그것도 나이 30으로.<br>
         	하지만 그와 동시에 그는 낭심을 잃었고, 뭐라도 해보겠다는 마음으로 비급을 읽고 수련하더니 이세계 소환을 했다. <br>
         	</p>
        </div>
     </main>
