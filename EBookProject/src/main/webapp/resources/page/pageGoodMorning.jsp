...
<body>
    ...
    <header id="headTitle">
     ...
     <main id="mainDetail">
         <div class="detail">
             <h4>책 소개</h4>
         <p>키스 한 번에 전설의 용을 깨운 여자, 다연과 천 년 넘게 잠들어있던 본능을 각성한 남자, 용이의 신비롭고 이상야릇한 러브 판타지 <br>
        ...
        <ol>
            ...
            <li>
                <a href="javascript://4" onclick="#">
                    <p class="text">
                        <strong> 4. 뜨겁고 낯선, 날것의 무언가</strong>
                        <span>2021.03.24</span></p>
                    <p class="approval">
                        <span class="coin_necessary" style="margin-right: 0.01rem;">3쿠키</span></p>
                </a>
