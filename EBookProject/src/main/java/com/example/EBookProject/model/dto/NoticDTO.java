...
public class NoticDTO {
	...
	private Date notic_regdate;					// 작성일
	private int notic_viewcnt;					//조회수
	private String notic_show;				// 화면 표시 여부
	...
	public String getNotic_show() {
		return notic_show;
	}



	public void setNotic_show(String notic_show) {
		this.notic_show = notic_show;
	}
	...
	public String toString() {
		return "NoticDTO [notic_no=" + notic_no + ", notic_content=" + notic_content + ", notic_title=" + notic_title
				+ ", notic_regdate=" + notic_regdate + ", notic_viewcnt=" + notic_viewcnt +",notic_show=" + notic_show + "]" ;
	}
